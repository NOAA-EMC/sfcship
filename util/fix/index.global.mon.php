...
<title>NCO Global Surface Marine Statistics</title>
<!-- TemplateEndEditable -->
<!-- TemplateBeginEditable name="head" -->
<meta name="DC.title" content="NCO Global Surface Marine Statistics">
<meta name="DC.description" content="NCO Surf. Mar. Plat Names">
<meta name="DC.keywords" content="NCO Operational Monitoring Branch, NWS Central Operations, NCEP Central Operations, Central Operations, National Centers for Environmental Prediction, National Weather Service, Global Surface Marine Statistics">
...
<!-- *******************CONTENT AREA ***************************-->
        ...
        <center>
           <h1>Global Surface Marine Monthly Statistics - Mon YYYY</h1>
           <table>
              <tbody>
                 <tr>
        ...
        <div class="content-body"> 
           <center>
           <pre>
              <?php include "surf_mar.mon.stats.txt" ?>
           </pre>
           </center>
        </div>
