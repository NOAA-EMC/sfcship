...
<title>NCO Ship and Platform Names</title>
<!-- TemplateEndEditable -->
<!-- TemplateBeginEditable name="head" -->
<meta name="DC.title" content="NCO Ship and Platform Names">
<meta name="DC.description" content="NCO Surf. Mar. Plat Names">
<meta name="DC.keywords" content="NCO Operational Monitoring Branch, NWS Central Operations, NCEP Central Operations, Central Operations, National Centers for Environmental Prediction, National Weather Service, Ship and Platform Names, Surface Marine Platform Names">
...
<body>
<a name="Ship_and_Platform_Names"></a> 
...
<!-- *******************CONTENT AREA ***************************-->
	...
	<h1 style="margin-top:0;margin-bottom:.25em; text-align: center">Ship and Platform Names</h1>
        <center><small><a href="printable.shtml" target="print">Printer Friendly Version</a></small></center>
	<center><hr></center>

	<div class="content-body">
           <pre>
	      <?php include "surf_mar.platnames.txt" ?>
           </pre>
        </div>
        <center><small><a href="#Ship_and_Platform_Names">Return to Top</a></small></center>
